...
import com.poc.reports.ExtentManager;
		...
		if(prop.getProperty("gridRun").equals("Y")) {
			...
			if(browserName.equals("Mozilla"))
				driver= new FirefoxDriver();
		         ...
		         System.setProperty("webdriver.chrome.driver","C:\\Users\\P10433741\\Desktop\\IBSAutomation\\autonml\\browser_drivers\\chromedriver.exe");
